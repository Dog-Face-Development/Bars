...
class NimView(object):
    def __init__(self, game):
        ...
        self.display("Please wait while the game loads...")
    ...
    def display(self, msg1, msg2=None):
        ...
        if msg2 is not None:
            ...
            self.writer.write(msg2, align="center", font=("Octin Sports RG",20,"bold"))
        self.writer.goto(0, - SCREENHEIGHT // 2 + 20)
        self.writer.pencolor("black")
        self.writer.write(msg1, align="center", font=("Octin Sports RG",18,"bold"))
        self.screen.tracer(True)
    ...
    def notify_move(self, row, col, maxspalte, player):
        if player == 0:
            ...
            time.sleep(0.5)
            self.display(" ... thinking ... still thinking ...")
            time.sleep(0.10)
            self.display("The computer is playing...")
            farbe = COLOR
...
class NimController(object):
    ...
    def __init__(self, game):
        ...
        self.game.view.display("\t      Welcome to Bars!\nLet's Go! Press the space bar to start game!")
